...
void plot_muon_monitors(std::string sin){
  ...
  TH1D *h1m1_gtd = new TH1D("h1m1_gtd", "h1m1_gtd", 100, 1.7, 1.9 );
  TH1D *h1m2_gtd = new TH1D("h1m2_gtd", "h1m2_gtd", 100, 5.2, 6);
  TH1D *h1m3_gtd = new TH1D("h1m3_gtd", "h1m3_gtd", 100, 0.38, 0.5);
  ...
  for(int i = 0; i < nevents; ++i){
    ...
    mm1_gtd->SetPoint(i, time/1000, m1/gtd);
    //mm2_gtd->SetPoint(i, time/1000, m2/gtd);
    //mm3_gtd->SetPoint(i, time/1000, m3/gtd);
    ...
    h1m1_gtd->Fill(m1/gtd);
    h1m2_gtd->Fill(m2/gtd);
    h1m3_gtd->Fill(m3/gtd);
